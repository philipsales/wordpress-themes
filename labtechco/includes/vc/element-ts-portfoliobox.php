...
$allParams = array_merge(
		...
		array( 
			array(
				...
				"description" => sprintf( esc_attr__("Show sortable category links above %s items so user can sort by just single click.",'labtechco'), $pf_type_title_singular ),
				"param_name"  => "sortable",
				"value"       => array(
			...
			array(
				...
				"description" => sprintf( esc_attr__("Show pagination links below %s boxes.",'labtechco'), $pf_type_title ),
			...
			array(
				"type"        => "checkbox",
				"heading"     => sprintf( esc_attr__("From %s", "labtechco"), $pf_cat_title_singular ),
				"description" => sprintf( esc_attr__('If you like to show %1$s from selected %2$s than select the category here.', 'labtechco'), $pf_type_title, $pf_cat_title ),
			...
			array(
				...
				"description" => sprintf( esc_attr__("How many %s item you want to show.", "labtechco"), $pf_type_title ),
				"param_name"  => "show",
				"value"       => array(
...
vc_map( array(
	"name"     => sprintf( esc_attr__("ThemeStek %s Box",'labtechco'), $pf_type_title_singular ),
