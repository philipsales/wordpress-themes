...
get_header(); ?>
	...
	<section id="primary" class="content-area <?php echo themestek_sanitize_html_classes(themestek_sidebar_class('content-area')); ?>">
		...
		<?php if ( have_posts() ) : ?>
			...
			$view   = ( !empty($labtechco_theme_options['teamcat_view']) ) ? $labtechco_theme_options['teamcat_view'] : 'top-image' ;
			$column = ( !empty($labtechco_theme_options['teamcat_column']) ) ? $labtechco_theme_options['teamcat_column'] : 'three' ;
